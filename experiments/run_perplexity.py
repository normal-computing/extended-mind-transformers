...
from experiments.perplexity import PerplexityExperiment
from experiments.utils import load_config, save_config, setup_log_dir
...
def main(argv):
    ...
    experiment = PerplexityExperiment(config=config["experiment_config"])
